...
export default function MetricasGrid({ metricas }) {
  ...
  const items = [
    ...
    { label: 'T. promedio',  value: metricas.tiempo_promedio_min ? `${metricas.tiempo_promedio_min} min` : '—', color: '#1B4F8A', bg: '#EBF2FF', icon: Clock,  sub: 'por pedido'       },
  ];
